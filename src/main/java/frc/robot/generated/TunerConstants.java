...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.1).withKI(0).withKD(0).withKS(0.12951).withKV(0.53831);
  ...
  public static final CANBus kCANBus = new CANBus("Can2", "./logs/example.hoot");

  // Theoretical free speed (m/s) at 12 V applied output;
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(6.71); // 6.71
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.232421875);
  private static final boolean kFrontLeftSteerMotorInverted = true;
  private static final boolean kFrontLeftCANcoderInverted = false;

  private static final Distance kFrontLeftXPos = Inches.of(12.38);
  ...
  private static final Distance kFrontRightXPos = Inches.of(12.38);
  ...
  private static final Distance kBackLeftXPos = Inches.of(-12.38);
  ...
  private static final Distance kBackRightXPos = Inches.of(-12.38);
